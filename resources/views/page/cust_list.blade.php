  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        @foreach ( $menus['mainMenu'] as $key => $mainMenu)
        @if ($mainMenu['menu_id']==0 && $mainMenu['idad_menu']==2)
        <li class="nav-item menu-open">
          ...
          <ul class="nav nav-treeview">
            @foreach ($menus['subMenu'] as $key2 =>$subMenu)

            <li class="nav-item">
              <a href="{{ url('/dashboard/'.$subMenu['url'])}}" class="nav-link active">
                <p>{{$subMenu['name']}}</p>
              </a>
            </li>
            <!-- <li class="nav-item">
